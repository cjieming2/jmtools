...
cd cnv_rd_$1_$3
ln -s /net/gerstein/jc2296/personal_genomes/g1k_cnvnator_root/unrelated/his.$1.ILLUMINA.root
ln -s /net/gerstein/jc2296/personal_genomes/g1k_cnvnator_root/unrelated/tree.$1.ILLUMINA.root
